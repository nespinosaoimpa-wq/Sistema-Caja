...
export default function ReferralsPage() {
  ...
  const shareText = `¡Hola! Te recomiendo Smart Caja para controlar el stock, ventas y fiados de tu negocio. Si te registrás con mi link tenés 14 días de prueba gratis y 30% de descuento en tu primer mes: ${referralLink}`
