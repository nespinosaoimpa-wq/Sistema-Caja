    ...
    <div className={styles.landingContainer} style={{ background: '#030816' }}>
      ...
      <section className={styles.hero} style={{ paddingTop: '100px', paddingBottom: '40px' }}>
        ...
        <p className={styles.heroDesc} style={{ maxWidth: '650px' }}>
          Dejá los cuadernos y las planillas manuales. Smart Caja te da control de inventario, arqueos auditados, fiados y cuotas en una sola pantalla. ¡Probá 14 días gratis hoy!
        </p>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' }}>
          ...
          <span style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>
            Cupón pre-aplicado en el checkout · 14 días de prueba completa gratis · Sin tarjetas
          </span>
        </div>
      </section>
